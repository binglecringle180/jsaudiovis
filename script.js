document.addEventListener("DOMContentLoaded", () => {
    const fstoggle = document.querySelector('#full');
    ...
    fileInput.addEventListener("change", async function() {
        ...
        function animate() {
            ...
            drawVisualizer(bufferLengthVisualizer, dataArrayVisualizer);
            
            analyserWaveform.getByteTimeDomainData(dataArrayWaveform);
            drawWaveform(bufferLengthWaveform, dataArrayWaveform);
